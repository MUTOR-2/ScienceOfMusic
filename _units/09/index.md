...
summary: "The word \"harmony\" has several connotations: in everyday speech, 
it suggests that things have been arranged in an orderly, pleasing fashion, 
while in music, it can refer to the sounding together of multiple notes, 
pleasing or not, or to more complex notions of how different harmonies relate 
to each other in a structural way. A scale is a closely related notion and 
refers to the collection of notes from which harmonies in a harmonic system 
are constructed. Scales and harmony are closely related to intonation, or the 
way in which we tune the different intervals of a scale. The most common 
system in Euro-American music today is called twelve-tone equal temperament, 
in which the octave is divided into twelve equal parts, however, there are 
...
references:
  ...
  blackwood:
    authors:
      - firstname: E.
        lastname: Blackwood
    title: 'Twelve microtonal etudes: for electronic music media, op. 28'
    publication: 'G. Schirmer'
    year: 1982
  ...
  bohlen:
    ...
    publication: 'Acustica, 39(2): 76-86'
    year: 1978
  ...
  grisey:
    authors:
      - firstname: G.
        lastname: Grisey
    title: "Tempus ex machina: a composer’s reflections on musical time"
    publication: 'Contemporary Music Review, 2(1): 239-276'
    year: 1987
  ...
  loui_et_al:
    ...
    publication: 'Music Perception, 27(5): 377-388'
    year: 2010
  ...
  muller_et_all:
    authors:
      ...
      - firstname: G.
        lastname: Hajdu
    title: 'Starting Over – Chances Afforded by a New Scale'
    publication: 'In 1001 Microtones, Stahnke, M. and Safari, S. (Eds.). Von Bockel, 127–172'
    year: 2014
  ...
  saariaho:
    authors:
      - firstname: K.
        lastname: Saariaho
    title: 'Timbre and harmony: Interpolations of timbral structures'
    publication: 'Contemporary Music Review, 2(1): 93-134'
    year: 1987
    
  sabat_and_schweinitz:
    authors:
      - firstname: M.
        lastname: Sabat
      - firstname: W.
        lastname: von Schweinitz
    title: 'The Extended Helmholtz-Ellis JI Pitch Notation'
    publication: 'Plainsound Music Edition'
    year: 2004
...
[Webster's dictionary](http://m-w.com/dictionary/harmony) defines harmony in reference to music as (1) _the combination of simultaneous musical notes in a chord, (2) the structure of music with respect to the composition and progression of chords or (3) the science of the structure, relation, and progression of chords._ In more general terms, harmony also denotes _the pleasing or congruent arrangement of parts_.
...
{% include begin-figure description="Listening example 1. The first minute of Capriccio (FbWV 506) by Johann Jakob Froberger played on an organ in meantone temperament." %}
{% include p/xwaveform-spectroscope-small src="./temperament_froberger.mp3" gain="1.0" %}
{% include end-figure %}


{% include begin-figure description="Listening example 2. Froberger's Capriccio played in equal temperament." %}
...
{% include img-figure url="./temperament_froberger.png" description="Froberger Cappriccio C maj" %}
...
{% include begin-figure description="Max Example: Just intonation intervals" %}
<div style="display: block; text-align: center; float: center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/ck6p6I6rssU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
{% include end-figure %}
...
{% include img-figure url="./temperament_archicembalo.png" description="The Archicembalo had a large number of tuning alternatives for the 12 keys of the chromatic scale." %}
...
{% include img-figure url="./ambiguity_schubert.png" description="Franz Schubert: Der Neugierige mm.35-46. The first marked area features the second inversion of the secondary dominant seventh chord on G resolving to the subdominant C in the key of G major. The second marked area features the German 6th chord, with the F respelled as E# resolving to the cadential 6-4 chord in B major." %}

{% include p/xwaveform-spectroscope-small src="./ambiguity_schubert.wav" gain="1.0" %}
(Audio source: [Randall Scarlata & Jeremy Denk](https://imslp.org/wiki/Die_sch%C3%B6ne_M%C3%BCllerin%2C_D.795_(Schubert%2C_Franz)))

{% include img-figure url="./ambiguity_cubes.jpg" description="Ambiguous Cubes Illusion" %}
...
{% comment %}
{% include mov-figure src="/MUTOR/assets/videos/unit9_calculationofequidistanttunings.mp4" type="mp4" description="Maxpatch example: Calculation of equidistant tunings based on stacking fifths" width="600px" %}
{% endcomment %}

{% include begin-figure description="Max Example: Fifth Stacker" %}
<div style="display: block; text-align: center; float: center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/ghV9KSgerZU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
{% include end-figure %}
...
{% include begin-figure description="Burning Petrol, an arrangement of the piano poem Vers la flamme by Alexander Scriabin for Bohlen-Pierce ensemble." %}
{% include p/xwaveform-spectroscope-small src="./microtonality_bp_hajdu.mp3" gain="1.0" %}
{% include end-figure %}
...
{% include img-figure url="./microtonality_gamelan_curve.png" description="Dissonance Curve for the pelog scale" width="400px" %}

{% include img-figure url="./microtonality_gamelan_orchestra.jpg" description="A Gamelan orchestra" %}
(Image source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Indra_Swara_gamelan.jpg))
...
P. Loui, D.L. Wessel, and C.L. Hudson Kam. Humans rapidly learn grammatical structure in a new musical scale. Music Perception 27(5):377-388, 2010.
