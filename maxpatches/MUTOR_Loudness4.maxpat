...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.5, 79.0, 281.0, 70.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 35.0, 51.0, 551.0, 38.0 ],
					"text" : "Choose a sound source and a duration for the sound: very short (25 ms), short (50 ms), medium (100 ms), long (150 ms) or very long (200 ms).",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 494.5, 140.5, 55.0, 22.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 906.999999999999886, 207.0, 29.5, 22.0 ],
					"text" : "200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 871.749999999999886, 207.0, 29.5, 22.0 ],
					"text" : "150"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 836.5, 207.0, 29.5, 22.0 ],
					"text" : "100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 801.25, 207.0, 29.5, 22.0 ],
					"text" : "50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 766.0, 207.0, 29.5, 22.0 ],
					"text" : "20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 766.0, 176.0, 195.249999999999886, 22.0 ],
					"text" : "sel 0 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-47",
					"items" : [ "very", "short", ",", "short", ",", "medium", ",", "long", ",", "very", "long" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 766.0, 148.0, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 99.0, 132.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 684.0, 251.0, 41.0, 22.0 ],
					"text" : "del 50"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 684.0, 167.0, 42.0, 22.0 ],
					"text" : "t b 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 684.0, 129.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 108.0, 46.0, 46.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 684.0, 279.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 626.0, 318.0, 109.0, 22.0 ],
					"text" : "adsr~ 10 10 0.6 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.5, 148.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 283.5, 119.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 325.0, 148.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 325.0, 119.0, 29.5, 22.0 ],
					"text" : "> 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 283.5, 255.0, 230.0, 22.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 454.0, 48.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-4",
					"items" : [ "off", ",", "noise", ",", "sine", 100, ",", "sine", 440, ",", "sine", 1000, ",", "sine", 4000 ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 454.0, 114.0, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 99.0, 108.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 494.5, 201.0, 66.0, 22.0 ],
					"text" : "cycle~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 157.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 389.0, 167.0, 38.0, 22.0 ],
					"text" : "pink~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 53.0, 225.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.0, 192.0, 19.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 157.0, 483.0, 344.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 593.5, 408.0, 51.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 536.0, 157.0, 483.0, 344.0 ],
					"range" : [ -2.0, 2.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1021.0, 157.0, 67.0, 353.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 0 ],
					"midpoints" : [ 716.5, 219.0, 635.5, 219.0 ],
					"source" : [ "obj-44", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 0 ],
					"midpoints" : [ 705.0, 218.0, 635.5, 218.0 ],
					"source" : [ "obj-44", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 463.5, 92.5, 775.5, 92.5 ],
					"order" : 0,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 293.0, 342.0, 603.0, 342.0 ],
					"source" : [ "obj-7", 0 ]
				}
