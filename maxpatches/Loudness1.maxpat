...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 285.0, 291.0, 48.0, 22.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 593.5, 267.0, 39.0, 22.0 ],
					"text" : "$1 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 593.5, 291.0, 48.0, 22.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.333333000000039, 183.0, 138.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1006.0, 141.5, 138.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 285.0, 219.0, 327.5, 22.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 593.5, 243.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 579.0, 139.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 285.0, 243.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 139.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 61.5, 183.0, 19.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 987.0, 141.5, 17.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.5, 156.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 61.5, 212.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 592.0, 156.0, 83.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 806.5, 176.0, 92.0, 17.0 ],
					"text" : "TONE 2 1000 Hz",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 279.0, 156.0, 63.0, 28.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 579.0, 163.0, 511.0, 163.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 163.0, 528.0, 163.0 ],
					"sonomedcolor" : [ 0.0, 0.749019607843137, 0.498039215686275, 1.0 ],
					"sonomedhicolor" : [ 1.0, 0.749019607843137, 0.0, 1.0 ],
					"sonomedlocolor" : [ 0.498039215686275, 0.0, 0.498039215686275, 1.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 50.0, 299.0, 48.0, 22.0 ],
									"text" : "line~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 114.5, 275.0, 39.0, 22.0 ],
									"text" : "$1 30"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 114.5, 299.0, 48.0, 22.0 ],
									"text" : "line~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 49.999979666666491, 355.5, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 114.5, 355.5, 30.0, 30.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1006.0, 120.5, 134.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 593.5, 315.0, 73.0, 22.0 ],
					"text" : "cycle~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 285.0, 315.0, 53.0, 22.0 ],
					"text" : "cycle~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 579.0, 328.0, 511.0, 163.0 ],
					"range" : [ -2.0, 2.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 328.0, 528.0, 163.0 ],
					"range" : [ -2.0, 2.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1092.0, 163.0, 52.0, 328.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 603.0, 394.0, 398.5, 394.0 ],
					"order" : 2,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 603.0, 394.0, 556.5, 394.0 ],
					"order" : 1,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 1046.833333333333485, 335.0, 305.0, 335.0 ],
					"source" : [ "obj-58", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 294.5, 370.5, 62.5, 370.5 ],
					"order" : 2,
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 294.5, 371.5, 218.5, 371.5 ],
					"order" : 1,
					"source" : [ "obj-7", 0 ]
				}
